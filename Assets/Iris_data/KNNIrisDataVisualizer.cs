...
public class KNNIrisDataVisualizer : MonoBehaviour {
    ...
    public KNNIrisPredictionClient client;
    ...
    private IrisDataPoint[] dataPoints = new IrisDataPoint[] {
    ...
    void Start() {
        ...
        foreach (IrisDataPoint point in dataPoints) {
